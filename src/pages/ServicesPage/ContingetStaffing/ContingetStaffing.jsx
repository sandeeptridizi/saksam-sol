...
const ContingetStaffing = () => {
  return <div>
      ...
      <div className='serviceheronotes'>
        ...
        <div className='serivcehighlight'>
          ...
          <div className='servicepoint'>
            <span className='servicetitle'>Lorem ipsum dolor si</span> <br></br>
            <span className='servicedesc'>Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.</span>
          </div>
        </div>
        <div className='serivcehighlight'>
          <div className='serviceicon'></div>
          <div className='servicepoint'>
            <span className='servicetitle'>Lorem ipsum dolor sit amet consectetur.</span> <br></br>
            <span className='servicedesc'>Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.</span>
          </div>
        </div>
        <div className='serivcehighlight'>
          <div className='serviceicon'></div>
          <div className='servicepoint'>
            <span className='servicetitle'>Lorem ipsum</span> <br></br>
            <span className='servicedesc'>Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.</span>
          </div>
        </div>
    ...
    <div className='servicebodydesc'>
      <span className='servicebodynote'>This Privacy Policy describes how JobsNextDoor from Taskify collects, uses, and protects the personal information you provide when joining our job seeker network. We are committed to ensuring your privacy and handling your data with care and respect.This Privacy Policy describes how JobsNextDoor from Taskify collects, uses, and protects the personal information you provide when joining our job seeker network. We are committed to ensuring your privacy and handling your data with care and respect.This Privacy Policy describes how JobsNextDoor from Taskify collects, uses, and protects the personal information you provide when joining our job seeker network. We are committed to ensuring your privacy and handling your data with care and respect.</span>
    </div>
    <div className='serviceadvantages'>
      <div className='advantageimagesection'>
        <span className='advantagetitle'>Advantages</span> <br></br>
        <span className='advantagedesc'>Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.</span><br></br>
      ...
      <div className='advantagepoint'>
        <div className='aboutrow'>
          <ul className='abouthighlight'>
            ...
            <li className='highlightdesc'>You get a 2-week free trial to kick the Smarty tries. We want you to.</li>
          </ul>
          <ul className='abouthighlight'>
            <li className='highlightnum'>2.</li>
            <li className='highlightheading'>What Do We Do</li>
            <li className='highlightdesc'>We give you a free course that guides you through the process.</li>
          </ul>
        </div>
         <div className='aboutrow'>
          <ul className='abouthighlight'>
            ...
            <li className='highlightdesc'>Use our multimedia lecturers, videos, and coaching sessions.</li>
          </ul>
          <ul className='abouthighlight'>
            <li className='highlightnum'>4.</li>
            <li className='highlightheading'>Create Success Story</li>
            <li className='highlightdesc'>With access to online learning resources anyone can transfrm.</li>
          </ul>
        </div>
      </div>
    </div>
