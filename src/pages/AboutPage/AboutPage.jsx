    ...
    <div className='abouthero'>
      <div className='abouthighlights'>
        <ul className='aboutinfo'>
          ...
          <li className='aboutdesc'>At Besnik Consultancy, we take pride in our values – service, integrity, and excellence. </li><br></br>
    ...
    <div className='visionmission'>
        <div>
          <ul className='vision'>
            ...
            <li className='visiondesc'>Project planning, engineering design, technical implementation, and quality assurance of waste management facilities</li>
          </ul>
        </div>
        <div>
          <ul className='vision'>
            ...
            <li className='visiondesc'>Administrative operations, human resources, policy coordination, and overall organizational management</li>
          </ul>
        </div>
      </div>
      <div className='founders'>
        <div className='foundersheading'>
          ...
          <span className='foundersdesc'>At Saksam Sol, we take pride in offering more than just products; we offer an experience. Here's what makes us unique:</span>
        </div>
